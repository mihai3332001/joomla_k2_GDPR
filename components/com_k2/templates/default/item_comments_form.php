...
<label class="formGDPR" for="checkboxGDPR">

<?php echo JText::_('K2_GDPR'); ?> </label><br />
<a href="#" data-toggle="modal" data-target="#exampleModal"> Click Aici</a>
<input type="checkbox" id="checkboxGDPR" name="GDPR" value="1" />
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Prelucrarea datelor cu caracter personal </h5>
